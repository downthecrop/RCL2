              ...
              <div v-else>
                <div style="display: grid; align-items: center; justify-content: center">
                  <div class="wrapper flex">
                    ...
                    <div class="ml-4">
                      <select v-model="description" class="p-2 bg-gray-800 text-white rounded">
                    ...
                    <div class="ml-4">
                      ...
                      <label for="private" class="ml-2 text-white">Private</label>
                    </div>
                    <div class="ml-4">
                      <button @click="() => addLink(inputData, description, isPrivate)"
...
import GenericHome from './GenericHome.vue'
