  ...
  <div class="overflow-hidden">
            ...
            <a class="flex-none" href="#">
              <svg class="w-28 h-auto" width="116" height="32" viewBox="0 0 116 32" fill="none"
                ...
                <path
                  ...
                  fill="currentColor" class="fill-violet-600 dark:fill-white" />
                <path
                  ...
                  class="stroke-violet-600 dark:stroke-white" stroke="currentColor" stroke-width="2" />
                <path
                  ...
                  <div
                    ...
                    <div class="md:grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                      ...
                      <div class="flex flex-col pt-4 md:pt-0 mx-1 md:mx-0">
                        <span class="text-sm font-semibold uppercase text-gray-800 dark:text-gray-200">Customer
                          stories</span>
                        ...
                        <a class="mt-4 group flex gap-x-5 items-center" href="#">
                          ...
                          <div class="grow">
                            <p class="text-gray-800 dark:text-gray-200">Preline Projects has proved to be most efficient
                              cloud based project tracking and bug tracking tool.</p>
                            <p
    ...
    <div class="relative">
      ...
      <div aria-hidden="true" class="flex absolute -top-48 left-0 -z-[1]">
        ...
        <div class="bg-slate-200 opacity-90 blur-3xl w-[577px] h-[300px] transform translate-y-32 dark:bg-slate-800/60">
        </div>
      </div>
      <!-- End Gradients -->
      ...
      <div class="max-w-[85rem] px-4 pt-10 sm:px-6 lg:px-8 lg:pt-14 mx-auto">
        ...
        <main id="content" role="main">
          <div class="text-center py-10 px-4 sm:px-6 lg:px-8">
            ...
            <p class="mt-3 text-lg text-gray-300">Cover is a one-page template for building simple and beautiful home
              pages using Tailwind CSS.</p>
        ...
        <div class="flex justify-center gap-x-6 sm:gap-x-12 lg:gap-x-24">
          ...
          <svg class="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 mx-auto sm:mx-0 text-gray-500" fill="none"
      ...
      <div
        class="absolute top-1/2 left-1/2 -z-[1] transform -translate-y-1/2 -translate-x-1/2 w-[340px] h-[340px] border border-dashed border-violet-200 rounded-full dark:border-violet-900/60">
      </div>
      <div
        class="absolute top-1/2 left-1/2 -z-[1] transform -translate-y-1/2 -translate-x-1/2 w-[575px] h-[575px] border border-dashed border-violet-200 rounded-full opacity-80 dark:border-violet-900/60">
      </div>
      <div
        class="absolute top-1/2 left-1/2 -z-[1] transform -translate-y-1/2 -translate-x-1/2 w-[840px] h-[840px] border border-dashed border-violet-200 rounded-full opacity-60 dark:border-violet-900/60">
      </div>
      <div
        class="absolute top-1/2 left-1/2 -z-[1] transform -translate-y-1/2 -translate-x-1/2 w-[1080px] h-[1080px] border border-dashed border-violet-200 rounded-full opacity-40 dark:border-violet-900/60">
      </div>
    </div>
    <!-- End Hero -->
  </div>
    ...
    <div class="grid md:grid-cols-6 gap-6">
      <div class="md:col-span-2">
        <div class="max-w-xs">
          ...
          <p class="mt-1 hidden md:block text-gray-600 dark:text-gray-400">Answers to the most frequently asked questions.
          </p>
        </div>
      </div>
      <!-- End Col -->
